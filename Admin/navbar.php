...
?>
    ...
    <div class="container">
        <a class="navbar-brand" href="halaman_admin.php"> Camille </a>
        ...
        <ul class="navbar-nav me-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="data_register.php">User Data</a>
            </li>
        </ul>
        <ul class="navbar-nav ms-auto">
            ...
            <?php if(isset($_SESSION['status_login_user'])):?>
                <li class="nav-item mt-2">
                    <a class="nav-link" href="#"><i class="fa-solid fa-cart-shopping"></i></i></a>
                </li>
